    ...
    <div className='min-h-screen bg-stone-50 pt-20 pb-16 px-4'>
        <div className='container mx-auto max-w-7xl'>
            <div className='mb-8'>
                <Link
                href={backLink}
                className='inline-flex items-center gap-2 text-stone-600 hover:text-[#5F8D75] transition-colors mb-4'
                >
                ...
                {!loading &&  meals.length > 0 && (
                    <p className='text-stone-600 mt-2'>
                        ...
                        {type=="cuisine" ? "dishes" : "recipes"} to explore and enjoy!
                    </p>
                )}
            </div>
            ...
            { loading && (
                <div className='flex flex-col justify-center items-center py-20'>
                    <Loader2 className='w-10 h-10 text-[#5F8D75] animate-spin mb-4'/>
