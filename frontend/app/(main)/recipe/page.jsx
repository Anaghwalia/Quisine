...
function RecipeContent() {
  ...
  useEffect(() => {
    ...
    // ADD THIS LINE to satisfy your backend!
    formData.append("recipeName", recipe.title); 
  ...
  useEffect(() => {
    if (recipeData?.success) {
      ...
      if (recipeData.fromDatabase) toast.success("Recipe loaded from database");
      else toast.success("New recipe generated and saved!");
    }
  }, [recipeData]);
      ...
      <div className="min-h-screen bg-stone-50 pt-24 pb-16">
        <div className="container mx-auto max-w-4xl text-center py-20">
          <div className="bg-green-50 w-20 h-20 border-2 border-green-200 flex items-center justify-center mx-auto mb-6">
            <AlertCircle className="w-10 h-10 text-[#5F8D75]" />
          </div>
          <h2 className="text-2xl font-bold text-stone-900 mb-2">
            No recipe specified
          </h2>
          <p className="text-stone-600 mb-6 font-light">
            Please share a recipe from the dashboard
          </p>
          <Link href={"/dashboard"}>
      ...
      <div className="min-h-screen bg-stone-50 pt-24 pb-16">
        <div className="container mx-auto max-w-4xl text-center py-20">
          <div className="text-center py-20">
            <ClockLoader className="mx-auto mb-6" color="#5F8D75" />
            ...
            <p className="text-stone-600 font-light">
              ...
              <span className="font-bold text-[#5F8D75]">{recipeName}</span>
              ...
            </p>
            <div className="mt-8 max-w-md mx-auto">
              <div className="flex items-center gap-3 text-sm text-stone-500">
                <div className="flex-1 h-1 bg-stone-200 overflow-hidden relative">
                  <div className="absolute left-0 top-0 h-full bg-[#5F8D75] animate-slow-fill" />
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16">
      <div className="container mx-auto max-w-4xl">
        <div className="mb-8">
          <Link
            href={"/dashboard"}
            className="inline-flex items-center gap-2 text-stone-600 hover:text-[#5F8D75] transition-colors mb-6 font-medium"
          >
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge
                variant={"outline"}
                className={
                  "text-[#5F8D75] border-2 border-green-200 capitalize"
                }
              >
                {recipe.cuisine}
              </Badge>
            ...
            <div className="flex flex-wrap gap-6 text-stone-600 mb-6">
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-[#5F8D75]" />
              ...
              <div className="flex items-center gap-2">
                <Users className="w-5 h-5 text-[#5F8D75]" />
                <span className="font-medium">
                  {recipe.servings}{" "}
              ...
              {recipe.nutrition?.calories && (
                <div className="flex items-center gap-2">
                  <Flame className="w-5 h-5 text-[#5F8D75]" />
                  <span className="font-medium">
      ...
      ${
        isSaved
          ? "bg-stone-800 hover:bg-stone-900 text-white" // Dark, grounded color for "Saved"
          : "bg-[#5F8D75] hover:bg-[#4A705C] text-white" // Brand green for the primary action
      } transition-all gap-2 shadow-sm
    `}
              >
                {saving || removing ? (
                  <>
              ...
              >
                {({ loading }) => (
                  <Button
                    variant="outline"
                    className="border-2 border-[#5F8D75] text-[#5F8D75] hover:bg-green-50 gap-2"
                    disabled={loading}
                  >
                  ...
                  <ul className="space-y-2">
                    {items.map((ingredient, i) => (
                      ...
                      >
                        ...
                        <span className="font-bold text-[#5F8D75] text-sm whitespace-nowrap">
                          {ingredient.amount}
                        </span>
                      </li>
                    ))}
               ...
               {recipe.nutrition && (
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  <h3 className="font-bold text-stone-900 mb-3 uppercase tracking-wide text-sm flex items-center gap-2">
                    ...
                    {!recipeData.isPro && (
                      <span className="text-xs bg-green-100 text-[#5F8D75] px-2 py-0.5 rounded-full font-semibold">
                        PRO
                      </span>
                    )}
                  </h3>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-green-50 p-3 text-center border-2 border-green-100">
                        <div className="text-2xl font-bold text-[#5F8D75]">
                          {recipe.nutrition.calories}
                        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-8 border-2 border-stone-200">
              ...
              <div>
                {recipe.instructions.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="absolute -left-5 top-0 w-10 h-10 bg-[#5F8D75] text-white flex items-center justify-center font-bold border-2 border-[#5F8D75]">
                      {step.step}
                    </div>
                    ...
                    <div>
                      ...
                      {step.tip && (
                        <div className="bg-green-50 border-l-4 border-[#5F8D75]p-4">
                          <p className="text-sm text-green-900 flex items-start gap-2">
                            <Lightbulb className="w-4 h-4 mt-0.5 flex-shrink-0 fill-[#5F8D75]" />
                            <span>
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-[#5F8D75] flex-shrink-0 mt-0.5" />
                  <div>
            ...
            {recipe.tips && recipe.tips.length > 0 && (
              <div className="bg-gradient-to-br from-green-50 to-amber-50 p-8 border-2 border-green-200">
                <h2 className="text-2xl font-bold text-stone-900 mb-4 flex items-center gap-2">
                  <Lightbulb className="w-6 h-6 text-[#5F8D75] fill-[#5F8D75]" />
                  Chef&apos;s Tips & Tricks
                  {!recipeData.isPro && (
                    <span className="text-xs bg-green-100 text-[#5F8D75] px-2 py-0.5 rounded-full font-semibold">
                      PRO
                ...
                >
                  <ul className="space-y-3">
                    {recipe.tips.map((tip, i) => (
                      ...
                      >
                        <CheckCircle2 className="w-5 h-5 text-[#5F8D75] flex-shrink-0 mt-0.5" />
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
          <div className="container mx-auto max-w-4xl text-center py-20">
            <Loader2 className="w-16 h-16 text-[#5F8D75] animate-spin mx-auto mb-6" />
